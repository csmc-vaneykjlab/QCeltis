...
def main():
    ...
    parser.add_argument('-d', '--data_percent_threshold', type=int_range(0, 100), default=50, help='[Optional] Data Threshold for Intensity CV - will only be used if platewise comparison is selected')
